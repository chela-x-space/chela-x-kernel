...
- `ADR-0003`: `K14 External Adapter Boundary` — `PROPOSED` on `2026-07-19`; proposes a transport-neutral external-adapter contract boundary above `kernel-service` while preserving K1-K13 APIs and forbidding K13 bypass or direct lower-layer invocation.
