...
- Architecture Freeze: `PRESERVED`
- Public API status: `FROZEN FOR NEXT-MILESTONE CONSUMPTION WITH NATIVE VERIFICATION BLOCKER`
...
- Verified: `NONE IN CURRENT CODEX ENVIRONMENT`
- Blocked: native test execution for `K7-001` through `K7-009` because linker `cc` is unavailable
