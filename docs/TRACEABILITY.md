...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `K14-001` | K14 title and architectural role require explicit authority above frozen K13. | `docs/plans/K14-IMPLEMENTATION-PLAN.md`, `docs/backlog/K14-BACKLOG.md`, `docs/ADR-0003-K14-EXTERNAL-ADAPTER-BOUNDARY.md` | `docs/ADR-0002-K13-SERVICE-INTEGRATION-BOUNDARY.md` | explicit K14 external-adapter milestone definition | human architecture authority | architecture review | `PLANNING_ONLY` | `BLOCKED PENDING ADR ACCEPTANCE` |
| `K14-002` | K14 must consume frozen K13 without bypassing K13, K12, K11, or K10. | `docs/plans/K14-IMPLEMENTATION-PLAN.md`, `docs/ADR-0003-K14-EXTERNAL-ADAPTER-BOUNDARY.md` | `docs/kernel-architecture/13-data-flow.md` | external-adapter coordination over K13 only | K13 frozen API | static dependency audit | `PLANNING_ONLY` | `BLOCKED PENDING ADR ACCEPTANCE` |
| `K14-003` | K14 remains additive, deterministic, technology-neutral, and infrastructure-free. | `docs/plans/K14-IMPLEMENTATION-PLAN.md`, `docs/ADR-0003-K14-EXTERNAL-ADAPTER-BOUNDARY.md` | `README.md`, `ARCHITECTURE.md` | additive contract-only boundary | K1-K13 frozen APIs | static architecture audit | `PLANNING_ONLY` | `BLOCKED PENDING ADR ACCEPTANCE` |
...
| `K14-005` | K14 preserves K13 service identity and capability meaning by coordination only. | `docs/plans/K14-IMPLEMENTATION-PLAN.md`, `docs/ADR-0003-K14-EXTERNAL-ADAPTER-BOUNDARY.md` | `docs/API.md`, `docs/API-FREEZE.md` | adapter identity and capability continuity over K13 only | K13 frozen semantics | contract planning | `PLANNING_ONLY` | `BLOCKED PENDING ADR ACCEPTANCE` |
| `K14-006` | K14 command and query intent remain coordinated through K13 only. | `docs/plans/K14-IMPLEMENTATION-PLAN.md`, `docs/ADR-0003-K14-EXTERNAL-ADAPTER-BOUNDARY.md` | `docs/API.md`, `docs/ADR-0002-K13-SERVICE-INTEGRATION-BOUNDARY.md` | adapter command and query continuity | K13 command/query boundary | failure-path planning | `PLANNING_ONLY` | `BLOCKED PENDING ADR ACCEPTANCE` |
| `K14-007` | K14 request and response continuity preserve service scope, correlation, and audit evidence. | `docs/plans/K14-IMPLEMENTATION-PLAN.md`, `docs/ADR-0003-K14-EXTERNAL-ADAPTER-BOUNDARY.md` | `docs/API.md`, `docs/VALIDATION.md` | adapter request and response evidence continuity | K13 request/response boundary | failure-path planning | `PLANNING_ONLY` | `BLOCKED PENDING ADR ACCEPTANCE` |
...
| `K14-010` | K14 preserves frozen compatibility and no reverse dependency from lower layers. | `docs/plans/K14-IMPLEMENTATION-PLAN.md`, `docs/ADR-0003-K14-EXTERNAL-ADAPTER-BOUNDARY.md` | `README.md`, `docs/IMPLEMENTATION-PLAN.md` | additive crate boundary above K13 only | K1-K13 frozen APIs | static dependency audit | `PLANNING_ONLY` | `BLOCKED PENDING ADR ACCEPTANCE` |
