...
- Milestone: `K12`
- Official proposed title: `K12 Application Integration`
- Planning status: `COMPLETE`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `K12-001` | Official K12 title and architectural role are proposed by `ADR-0001` and require human acceptance before implementation. | `docs/plans/K12-IMPLEMENTATION-PLAN.md`, `docs/ADR-0001-K12-APPLICATION-INTEGRATION-BOUNDARY.md` | `docs/kernel-architecture/15-roadmap.md`, `docs/kernel-architecture/16-traceability.md` | milestone-definition closure | human architecture authority | architecture review | `PLANNING_ONLY` | `AUTHORIZED AFTER ADR ACCEPTANCE` |
| `K12-002` | Any future K12 capability must consume frozen K11 Studio contracts without modifying them. | `docs/plans/K12-IMPLEMENTATION-PLAN.md`, `docs/ADR-0001-K12-APPLICATION-INTEGRATION-BOUNDARY.md` | `docs/kernel-architecture/12-studio-integration-architecture.md` §1-§14 | frozen Studio boundary preservation | K11 frozen contracts | static dependency audit | `PLANNING_ONLY` | `AUTHORIZED AFTER ADR ACCEPTANCE` |
| `K12-003` | Any future K12 flow must preserve the `external -> K12 -> K11 -> K10 -> Kernel` dependency direction. | `docs/plans/K12-IMPLEMENTATION-PLAN.md`, `docs/ADR-0001-K12-APPLICATION-INTEGRATION-BOUNDARY.md` | `docs/kernel-architecture/13-data-flow.md` §3-§10, `docs/kernel-architecture/14-sequence-diagrams.md` §6 | gateway and Studio boundary preservation | K10 and K11 frozen boundaries | architecture conformance audit | `PLANNING_ONLY` | `AUTHORIZED AFTER ADR ACCEPTANCE` |
| `K12-004` | K12 must not embed UI rendering or presentation concerns into frozen Kernel layers. | `docs/plans/K12-IMPLEMENTATION-PLAN.md`, `docs/ADR-0001-K12-APPLICATION-INTEGRATION-BOUNDARY.md` | `docs/kernel-architecture/01-kernel-overview.md` §6-§8 | lower-layer boundary preservation | K1-K11 frozen APIs | static dependency audit | `PLANNING_ONLY` | `AUTHORIZED AFTER ADR ACCEPTANCE` |
| `K12-005` | Concrete frontend or presentation runtime selection requires separate architecture authority beyond `ADR-0001`. | `docs/plans/K12-IMPLEMENTATION-PLAN.md`, `docs/ADR-0001-K12-APPLICATION-INTEGRATION-BOUNDARY.md` | `docs/plans/K11-IMPLEMENTATION-PLAN.md`, `docs/backlog/K11-BACKLOG.md` | framework-selection blocker | architecture freeze | later ADR review | `PLANNING_ONLY` | `REQUIRES LATER ADR` |
| `K12-006` | K12 must preserve K10 authentication, authorization, error, and rate-governance semantics without reinterpretation. | `docs/plans/K12-IMPLEMENTATION-PLAN.md`, `docs/ADR-0001-K12-APPLICATION-INTEGRATION-BOUNDARY.md` | `docs/kernel-architecture/11-api-gateway-architecture.md` §6-§13 | trust-boundary preservation | K10 frozen API | contract and security tests | `PLANNING_ONLY` | `AUTHORIZED AFTER ADR ACCEPTANCE` |
| `K12-007` | K12 must preserve K11 scope, correlation, audit, and view-intent continuity. | `docs/plans/K12-IMPLEMENTATION-PLAN.md`, `docs/ADR-0001-K12-APPLICATION-INTEGRATION-BOUNDARY.md` | `docs/kernel-architecture/12-studio-integration-architecture.md` §12, `docs/kernel-architecture/13-data-flow.md` §10 | request and response continuity | K11 frozen API | contract and failure-path tests | `PLANNING_ONLY` | `AUTHORIZED AFTER ADR ACCEPTANCE` |
| `K12-008` | Any K12 runtime, transport, persistence, session, or provider boundary requires architecture beyond `ADR-0001`. | `docs/plans/K12-IMPLEMENTATION-PLAN.md`, `docs/ADR-0001-K12-APPLICATION-INTEGRATION-BOUNDARY.md` | `ARCHITECTURE.md`, `docs/kernel-architecture/02-design-principles.md` §13-§16 | architecture-expansion gate | approved ADR | later ADR review | `PLANNING_ONLY` | `REQUIRES LATER ADR` |
| `K12-009` | K12 must maintain traceability without fabricated direct CES identifiers. | `docs/plans/K12-IMPLEMENTATION-PLAN.md`, `docs/ADR-0001-K12-APPLICATION-INTEGRATION-BOUNDARY.md` | `docs/kernel-architecture/16-traceability.md`, `docs/TRACEABILITY.md` | additive traceability | inherited traceability baseline | documentation review | `PLANNING_ONLY` | `AUTHORIZED AFTER ADR ACCEPTANCE` |
| `K12-010` | Implementation remains blocked until human review acts on the ADR proposal. | `docs/plans/K12-IMPLEMENTATION-PLAN.md`, `docs/ADR-0001-K12-APPLICATION-INTEGRATION-BOUNDARY.md` | inherited governance baseline | governance gate | human review and ADR | governance review | `PLANNING_ONLY` | `AUTHORIZED AFTER ADR ACCEPTANCE` |
