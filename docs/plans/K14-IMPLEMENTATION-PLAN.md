...
- define a technology-neutral adapter-facing coordination boundary above K13
...
| --- | --- | --- | --- | --- | --- | --- |
| `K14-001` | `docs/ADR-0002-K13-SERVICE-INTEGRATION-BOUNDARY.md` | define the next additive adapter-facing title and role above K13 only | human architecture authority | architecture review | K1-K13 remain frozen | `BLOCKED PENDING ADR` |
| `K14-002` | `docs/ADR-0002-K13-SERVICE-INTEGRATION-BOUNDARY.md`, `docs/kernel-architecture/13-data-flow.md` | K14 consumes K13 and never bypasses K13, K12, K11, or K10 | frozen K13 boundary | static dependency audit | no lower-layer bypass | `BLOCKED PENDING ADR` |
| `K14-003` | `README.md`, `ARCHITECTURE.md` | K14 remains additive, deterministic, technology-neutral, transport-neutral, and infrastructure-free | architecture freeze | static architecture audit | no runtime or infrastructure introduction | `BLOCKED PENDING ADR` |
...
| `K14-005` | `docs/API.md`, `docs/API-FREEZE.md` | adapter identity and capability contracts preserve frozen K13 service meaning only | frozen K13 service contracts | contract planning | no second identity or capability model | `BLOCKED PENDING ADR` |
| `K14-006` | `docs/API.md`, `docs/ADR-0002-K13-SERVICE-INTEGRATION-BOUNDARY.md` | adapter command and query intent remain coordinated through K13 only | frozen K13 command/query semantics | failure-path planning | no parallel command/query semantics | `BLOCKED PENDING ADR` |
| `K14-007` | `docs/API.md`, `docs/VALIDATION.md` | adapter request and response continuity preserve service identity, scope, correlation, and audit evidence | frozen K13 request and response evidence | contract planning | no K13 semantic drift | `BLOCKED PENDING ADR` |
...
- approve or reject the proposed title `K14 Adapter Integration`
